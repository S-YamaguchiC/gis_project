<<<<<<< HEAD:src/main/java/com/example/linebot/line/Callback.java
    ...
    public Message handleMessage(MessageEvent<TextMessageContent> event) {
        ...
        switch (text) {
            ...
            case "liff":
                ...
                return reply("LIFF -> " + "line://app/1596332300-ZdeXBggY");
            default:
                if(text.isEmpty()) {
                    return reply("？");
                } else {
...
>>>>>>> refs/remotes/origin/master:src/main/java/com/example/linebot/Callback.java
